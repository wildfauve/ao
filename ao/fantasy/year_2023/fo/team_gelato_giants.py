...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles).match('1.3').winner(men.Arnaldi).in_sets(4)  # (   ) Matteo Arnaldi  OR  (   ) Daniel Elahi Galan
    ...
    TEAM.draw(mens_singles).match('1.9').winner(men.Fognini).in_sets(5)  # ( 10) Felix Auger-Aliassime  OR  (   ) Fabio Fognini
    ...
    TEAM.draw(mens_singles).match('1.19').winner(men.Cecchinato).in_sets(5)  # (   ) Luca Van Assche  OR  (   ) Marco Cecchinato
    TEAM.draw(mens_singles).match('1.20').winner(men.Davidovich_Fokina).in_sets(4)  # (  W) Arthur Fils  OR  ( 29) Alejandro Davidovich Fokina
    ...
    TEAM.draw(mens_singles).match('1.27').winner(men.Ramos_Vinolas).in_sets(4)  # (   ) Stan Wawrinka  OR  (   ) Albert Ramos-Vinolas
    ...
    TEAM.draw(mens_singles).match('1.30').winner(men.Mannarino).in_sets(4)  # (   ) Adrian Mannarino  OR  (   ) Ugo Humbert
    ...
    TEAM.draw(mens_singles).match('1.47').winner(men.Zeppieri).in_sets(4)  # (   ) Alexander Bublik  OR  (  Q) Giulio Zeppieri
    ...
    TEAM.draw(mens_singles).match('1.50').winner(men.Huesler).in_sets(4)  # (   ) Daniel Altmaier  OR  (   ) Marc-Andrea Huesler
    TEAM.draw(mens_singles).match('1.51').winner(men.Barrere).in_sets(4)  # (   ) Emil Ruusuvuori  OR  (   ) Gregoire Barrere
...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles).match('1.13').winner(women.Parry).in_sets(3)  # ( 25) Anhelina Kalinina  OR  (  W) Diane Parry
    TEAM.draw(womens_singles).match('1.14').winner(women.Riske_Amritraj).in_sets(3)  # (  Q) Mirra Andreeva  OR  (   ) Alison Riske-Amritraj
    TEAM.draw(womens_singles).match('1.15').winner(women.Grabher).in_sets(3)  # (  Q) Arantxa Rus  OR  (   ) Julia Grabher
    ...
    TEAM.draw(womens_singles).match('1.18').winner(women.Noskova).in_sets(3)  # (   ) Linda Noskova  OR  (   ) Danka Kovinic
    TEAM.draw(womens_singles).match('1.19').winner(women.Burel).in_sets(3)  # (  W) Clara Burel  OR  (   ) Sorribes Tormo
    ...
    TEAM.draw(womens_singles).match('1.25').winner(women.Cocciaretto).in_sets(3)  # ( 10) Petra Kvitova  OR  (   ) Elisabetta Cocciaretto
    ...
    TEAM.draw(womens_singles).match('1.29').winner(women.Paolini).in_sets(3)  # ( 30) Sorana Cirstea  OR  (   ) Jasmine Paolini
    ...
    TEAM.draw(womens_singles).match('1.32').winner(women.Bronzetti).in_sets(3)  # (   ) Lucia Bronzetti  OR  (  7) Ons Jabeur
    ...
    TEAM.draw(womens_singles).match('1.35').winner(women.Errani).in_sets(2)  # (   ) Sara Errani  OR  (   ) Jil Teichmann
    ...
    TEAM.draw(womens_singles).match('1.50').winner(women.Bonaventure).in_sets(3)  # (   ) Anna Blinkova  OR  (   ) Ysaline Bonaventure
    ...
    TEAM.draw(womens_singles).match('1.55').winner(women.Parks).in_sets(2)  # (   ) Marketa Vondrousova  OR  (   ) Alycia Parks

...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.4').winner(women.Andreeva_Mirra).in_sets(3)  # (  Q) Andreeva_Mirra  OR  (  6) Gauff
    TEAM.draw(womens_singles).match('3.5').winner(women.Sorribes_Tormo).in_sets(3)  # (  4) Rybakina  OR  (   ) Sorribes_Tormo
    TEAM.draw(womens_singles).match('3.6').winner(women.Alexandrova).in_sets(3)  # ( 23) Alexandrova  OR  ( 14) Haddad_Maia
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.19').winner(men.Hanfmann).in_sets(5)  # ( 23) Cerundolo_Francisco  OR  (  L) Hanfmann
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.7').winner(women.Andreeva_Mirra).in_sets(3)  # (  W) Parry  OR  (  Q) Andreeva_Mirra

...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.4').winner(men.Pouille).in_sets(5)  # (  Q) Pouille  OR  ( 14) Norrie
    TEAM.draw(mens_singles).match('2.5').winner(men.Kubler).in_sets(5)  # (   ) Fognini  OR  (   ) Kubler
    TEAM.draw(mens_singles).match('2.6').winner(men.Korda).in_sets(4)  # (  Q) Ofner  OR  ( 24) Korda
    TEAM.draw(mens_singles).match('2.7').winner(men.Schwartzman).in_sets(5)  # (   ) Schwartzman  OR  (   ) Borges
    TEAM.draw(mens_singles).match('2.8').winner(men.Carballes_Baena).in_sets(5)  # (   ) Carballes_Baena  OR  (  5) Tsitsipas
    TEAM.draw(mens_singles).match('2.9').winner(men.Djokovic).in_sets(3)  # (  3) Djokovic  OR  (   ) Fucsovics
    TEAM.draw(mens_singles).match('2.10').winner(men.Davidovich_Fokina).in_sets(5)  # (   ) Van_Assche  OR  ( 29) Davidovich_Fokina
    TEAM.draw(mens_singles).match('2.11').winner(men.Bautista_Agut).in_sets(4)  # ( 19) Bautista_Agut  OR  (   ) Varillas
    TEAM.draw(mens_singles).match('2.12').winner(men.Hurkacz).in_sets(5)  # (   ) Griekspoor  OR  ( 13) Hurkacz
    TEAM.draw(mens_singles).match('2.13').winner(men.Khachanov).in_sets(5)  # ( 11) Khachanov  OR  (  Q) Albot
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.17').winner(women.Muchova).in_sets(3)  # (   ) Muchova  OR  (   ) Podoroska
    ...
    TEAM.draw(womens_singles).match('2.21').winner(women.Samsonova).in_sets(3)  # ( 15) Samsonova  OR  (   ) Pavlyuchenkova
    ...
    TEAM.draw(womens_singles).match('2.25').winner(women.Blinkova).in_sets(3)  # (  5) Garcia  OR  (   ) Blinkova
    TEAM.draw(womens_singles).match('2.26').winner(women.Hunter).in_sets(3)  # (  Q) Hunter  OR  (   ) Svitolina
    TEAM.draw(womens_singles).match('2.27').winner(women.Stearns).in_sets(3)  # ( 17) Ostapenko  OR  (   ) Stearns

...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.6').winner(women.Haddad_Maia).in_sets(2)  # ( 23) Alexandrova  OR  ( 14) Haddad_Maia
    ...
    TEAM.draw(womens_singles).match('3.11').winner(women.Potapova).in_sets(2)  # (   ) Pavlyuchenkova  OR  ( 24) Potapova
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.11').winner(women.Alexandrova).in_sets(2)  # ( 23) Alexandrova  OR  (   ) Friedsam
...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles).match('1.2').winner(men.Daniel).in_sets(4)  # (   ) Christopher O'Connell  OR  (   ) Taro Daniel
    ...
    TEAM.draw(mens_singles).match('1.15').winner(men.Nava).in_sets(5)  # (   ) Roberto Carballes Baena  OR  (  Q) Emilio Nava
    ...
    TEAM.draw(mens_singles).match('1.18').winner(men.Fucsovics).in_sets(3)  # (   ) Marton Fucsovics  OR  (  W) Hugo Grenier

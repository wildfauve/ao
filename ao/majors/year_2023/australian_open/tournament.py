...
AO2023MensSingles.has_entry(players.Minaur, seed=22)
...
AO2023MensSingles.has_entry(players.Agut, seed=24)
...
AO2023WomensSingles.has_entry(players.Zhang_Shuai, seed=23)
...
AO2023WomensSingles.has_entry(players.Fruhvirtova_Linda, seed=None)
